...
parser.add_argument('--adv_name', type=str, required=True, help='DOESNT MATTER FOR THIS BASELINE')
...
parser.add_argument('--adv_fraction', type=float, default=0.0, help='DOESNT MATTER')
...
save_prefix = 'BASELINE-env-{}_{}_Exp{}_Itr{}_BS{}_Adv{}'.format(env_name, adv_name, n_exps, n_itr, batch_size, adv_fraction)
