...
do
    ...
    do
        ...
        echo $PROCSTRING
        qsub -N ${PROCSTRING} -l nodes=1:ppn=8 -l walltime=99:99:99:99 ${LOGSTRING} -v env=${env},adv_fraction=${adv_fraction},PROCSTRING=${PROCSTRING} yoda_rl_adv_driver.sh
    done
done
