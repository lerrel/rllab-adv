...
OUTPUT_FILER=/home/${USER}/tmpoutputs_adv/${PROCSTRING_BASENAME}.${HOSTNAME}.$$.output

cd /home/lerrelp/rllab/adversary_scripts

#run a niced python script 
nice python train_trpo_var_adversary.py --env $env --adv_name adv --n_exps 3 --n_itr 500 --layer_size 100 50 25 --batch_size 25000 --if_render 0 --save_every 100 --adv_fraction $adv_fraction > $OUTPUT_FILER
